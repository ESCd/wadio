...
public sealed class IcecastClient( HttpClient http )
{
    public async Task<IcecastStreamReader> GetReader( Uri url, CancellationToken cancellation = default )
    {
...
{
    public static async Task<IcecastStreamReader> GetIcecastReader( this HttpClient http, Uri url, CancellationToken cancellation = default )
    {
