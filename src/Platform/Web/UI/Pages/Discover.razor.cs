...
public sealed record DiscoverState : State<DiscoverState>
{
    ...
    private static async ValueTask<ImmutableArray<Api.Abstractions.Station>> Search( IStationsApi api, SearchStationsParameters parameters, CancellationToken cancellation = default )
    {
        ArgumentNullException.ThrowIfNull( api );
