...
var api = builder.AddProject<Projects.Api>( "api" )
    ...
    .WithComputeEnvironment( compose )
    .WithPlatformDefaults( parameters )
    .WithEnvironment( "CloudflareApi__Images__AccountId", parameters.CloudflareImagesAccount )
    .WithEnvironment( "CloudflareApi__Images__AccountHash", parameters.CloudflareImagesHash )
    .WithEnvironment( "CloudflareApi__Images__ApiToken", parameters.CloudflareImagesToken )
